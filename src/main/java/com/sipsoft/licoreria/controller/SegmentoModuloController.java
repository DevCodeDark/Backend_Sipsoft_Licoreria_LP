...
public class SegmentoModuloController {
    ...
    public ResponseEntity<SegmentoModulo> buscarPorId(
            @Parameter(description = "ID del segmento de módulo", required = true) 
    ...
    public ResponseEntity<SegmentoModulo> buscarPorIdConModulos(
            @Parameter(description = "ID del segmento de módulo", required = true) 
            @PathVariable Integer id) {
    ...
    public ResponseEntity<Object> actualizar(@RequestBody SegmentoModuloDTO dto) {
        ...
        Optional<SegmentoModulo> segmentoModuloExistenteOpt = segmentoModuloService.buscarPorIdActivo(dto.getIdSegmento());
        if (segmentoModuloExistenteOpt.isEmpty()) {
            return ResponseEntity.notFound().build();
        }
        
        // Verificar si ya existe otro segmento de módulo con esa descripción
        Optional<SegmentoModulo> segmentoModuloConDescripcionOpt = segmentoModuloService.buscarPorDescripcion(dto.getDescripcionSegmento());
        ...
        segmentoModulo.setDescripcionSegmento(dto.getDescripcionSegmento());
        segmentoModulo.setIconoSegmento(dto.getIconoSegmento());
        segmentoModulo.setEstadoSegmento(dto.getEstadoSegmento() != null ? dto.getEstadoSegmento() : segmentoModulo.getEstadoSegmento());
    ...
    public ResponseEntity<List<SegmentoModulo>> buscarPorDescripcion(
            @Parameter(description = "Texto a buscar en la descripción del segmento de módulo", required = true)
